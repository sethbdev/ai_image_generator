...
const CreatePost = () => {
  //navigate back to home when post is created
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>Once you have generated the image you prefer, you can share it with the community</p>
          <button
            type='submit'
